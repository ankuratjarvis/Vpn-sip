...
class VideoPreviewHandler implements SurfaceHolder.Callback
{
    ...
    {
        if (SipMainActivity.currentCall != null &&
            SipMainActivity.currentCall.vidWin != null &&
            SipMainActivity.currentCall.vidPrev != null)
        {
            if (videoPreviewActive) {
                ...
                try {
                    SipMainActivity.currentCall.vidPrev.start(vidPrevParam);
                } catch (Exception e) {
                    System.out.println(e);
                }
            } else {
                try {
                    SipMainActivity.currentCall.vidPrev.stop();
                } catch (Exception e) {
                    System.out.println(e);
                }
            }
                          ...
                          implements Handler.Callback, SurfaceHolder.Callback
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(com.example.myapplication.R.layout.activity_call);
        ...
        SurfaceView surfacePreview = (SurfaceView)
                                  findViewById(com.example.myapplication.R.id.surfacePreviewCapture);
        ...
        if (SipMainActivity.currentCall != null) {
            try {
                lastCallInfo = SipMainActivity.currentCall.getInfo();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (MyApp.ep != null && SipMainActivity.account != null) {
            try {
                AccountConfig cfg = SipMainActivity.account.cfg;
    ...
    private void updateVideoWindow(boolean show)
    {
            ...
            SipMainActivity.currentCall.vidPrev != null)
        {
            ...
            try {
                SipMainActivity.currentCall.vidWin.setWindow(vidWH);
            } catch (Exception e) {
                System.out.println(e);
            }
        }
    ...
    public void acceptCall(View view)
    {
        ...
        try {
            SipMainActivity.currentCall.answer(prm);
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    public void hangupCall(View view)
    {
        ...
        if (SipMainActivity.currentCall != null) {
            ...
            try {
                SipMainActivity.currentCall.hangup(prm);
            } catch (Exception e) {
                System.out.println(e);
            }
        }
                                  ...
                                  Button buttonShowPreview)
    {
        ...
        buttonShowPreview.setText(previewHandler.videoPreviewActive?
                                  getString(com.example.myapplication.R.string.hide_preview):
                                  getString(com.example.myapplication.R.string.show_preview));
    }
    ...
    {
        if (m.what == SipMainActivity.MSG_TYPE.CALL_STATE) {

            lastCallInfo = (CallInfo) m.obj;
            updateCallState(lastCallInfo);

        } else if (m.what == SipMainActivity.MSG_TYPE.CALL_MEDIA_STATE) {

            if (SipMainActivity.currentCall.vidWin != null) {
    ...
    private void updateCallState(CallInfo ci) {
        TextView tvPeer  = (TextView) findViewById(com.example.myapplication.R.id.textViewPeer);
        TextView tvState = (TextView) findViewById(com.example.myapplication.R.id.textViewCallState);
        Button buttonHangup = (Button) findViewById(com.example.myapplication.R.id.buttonHangup);
        Button buttonAccept = (Button) findViewById(com.example.myapplication.R.id.buttonAccept);
        String call_state = "";
